...
TAG_T = "MogalakwenaTransformationsFms"
...
def mog_transform_tbl_Equipment(base_input_path, site_executor, input_config):
  logger.info(TAG_T,"Performaing Transformation for Equipment")
  ...
  logger.info(TAG_T,"reference_input_path : "+reference_input_path)
  ...
  try:
    ...
    logger.error(TAG_T,"ReadException","Failed to read the data from path {} : {}".format(aux_path, str(e)))
    raise DataTransformationException(TAG_T,"ReadException","Failed to read the data from path {}".format(aux_path))
  ...
  try:
    ...
    logger.error(TAG_T,"ReadException","Failed to read the data from path {} : {}".format(eqmt_path, str(e)))
    raise DataTransformationException(TAG_T,"ReadException","Failed to read the data from path {}".format(eqmt_path))
  ...
  try:
    ...
    logger.error(TAG_T,"TransformationException","Failed to perform union operation for table Equipment : {}".format(str(e)))
    raise DataTransformationException(TAG_T,"TransformationException",\
  ...
  try:
    ...
    logger.error(TAG_T,"ReadException","Failed to read the data from path {} : {}".format(catalog_path, str(e)))
    raise DataTransformationException(TAG_T,"ReadException","Failed to read the data from path {}".format(catalog_path))
  ...
  try:
    ...
    logger.error(TAG_LBT,"TransformationException","Failed to perform join operation for table Equipment : {}".format(str(e)))
    raise DataTransformationException(TAG_LBT,"TransformationException",\
...
def mog_transform_tbl_equipment_status(base_input_path, site_executor, input_config):
  logger.info(TAG_T,"Performaing Transformation for Equipment Status")
  ...
  shift_info_df = mog_transform_tbl_shift_info(base_input_path, site_executor, input_config).where(col("ShiftId").isNotNull()) .select('ShiftId','Crew').withColumnRenamed('ShiftId', 'ShiftId_df')

  try:
    joined_equip_status_df = eqmt_status_df.join(shift_info_df, eqmt_status_df.ShiftId == shift_info_df.ShiftId_df ,'left')
    transformed_Equipment_Status_df = joined_equip_status_df.withColumn('Status_Start_Time', from_unixtime(unix_timestamp('FieldId', 'HH:mm:ss'),'HH:mm:ss')) \
    ...
    logger.error(TAG_T,"TransformationException","Failed to perform join operation for table Equipment status : {}".format(str(e)))
    raise DataTransformationException(TAG_T,"TransformationException",\
  ...
  tbl_Equipment_Status_df = transformed_Equipment_Status_df.select("Status_Start_Time","Shift_Id","Status_Start_Timestamp", \
                                                                   ...
                                                                   "Delay_Type","Comment","Operator_Id","Is_Aux","Site_Name", "Src_Application","Status_End_Timestamp","Shift_Code","Shift_Date","Source_Id","crew_name")
...
def mog_transform_tbl_delay_reasons(base_input_path, site_executor, input_config):
  ...
  try:
    ...
    logger.error(TAG_T,"ReadException","Failed to read the data from path {} : {}".format(enum_path, str(e)))
    raise DataTransformationException(TAG_T,"ReadException","Failed to read the data from path {}".format(enum_path))
  ...
  try:
    ...
    logger.error(TAG_T,"ReadException","Failed to read the data from path {} : {}".format(ext_reasons_path, str(e)))
    raise DataTransformationException(TAG_T,"ReadException","Failed to read the data from path {}".format(ext_reasons_path))
  ...
  try:
    ...
    logger.error(TAG_T,"TransformationException","Failed to perform join operation for table Delay Reasons: {}".format(str(e)))
    raise DataTransformationException(TAG_T,"TransformationException",\
...
# Getting Delay Reasons Dependent Entity Tables
def mog_transform_tbl_shovel_buckets(base_input_path, site_executor, input_config):
  ...
  try:
    ...
    logger.error(TAG_T,"ReadException","Failed to read the data from path {} :{}".format(shift_load_bucket_pivot_path, str(e)))
    raise DataTransformationException(TAG_T,"ReadException","Failed to read the data from path {}".format(shift_load_bucket_pivot_path))
...
# Transforming the necessay columns and renaming the others as per the EDM. TO ASK Hesten for ShiftStartTimestamp
  try:
    ...
    logger.error(TAG_T,"TransformationException","Failed to perform column rename operation for table Shovel Buckets: {}".format(str(e)))
    raise DataTransformationException(TAG_T,"TransformationException",\
...
def mog_transform_tbl_material(base_input_path, site_executor, input_config):
  logger.info(TAG_T,"Performaing Transformation for Material")
  ...
  try:
    ...
    logger.error(TAG_T,"ReadException","Failed to read the data from path {} : {}".format(enum_material_path, str(e)))
    raise DataTransformationException(TAG_T,"ReadException","Failed to read the data from path {}".format(enum_material_path))
...
# Transforming the Material entity, no such transformations just need to rename and copy as-is
  ...
  try:
    ...
    logger.error(TAG_T,"TransformationException","Failed to perform column rename operation for table Material: {}".format(str(e)))
    raise DataTransformationException(TAG_T,"TransformationException",\
...
# Getting Material Entity Table
def mog_transform_tbl_truck_loads(base_input_path, site_executor, input_config):
  logger.info(TAG_T,"Performaing Transformation for Truck Loads")
  ...
  try:
    ...
    logger.error(TAG_T,"ReadException","Failed to read the data from path {}: {}".format(shift_info_path, str(e)))
    raise DataTransformationException(TAG_T,"ReadException","Failed to read the data from path {}".format(shift_info_path))
  ...
  try:
    ...
    logger.error(TAG_T,"ReadException","Failed to read the data from path {} : {}".format(shift_loads_path, str(e)))
    raise DataTransformationException(TAG_T,"ReadException","Failed to read the data from path {}".format(shift_loads_path))
  ...
  try:
    ...
    logger.error(TAG_LBT,"ReadException",message)
    raise DataTransformationException(TAG_LBT,"ReadException",message)
  ...
  try:
    ...
    logger.error(TAG_T,"ReadException","Failed to renamed the column : {}".format(str(e)))
    raise DataTransformationException(TAG_T,"ReadException","Failed to renamed the column: renamed_df")
  ...
  try:
    ...
    logger.error(TAG_T,"ReadException","Failed to select the column from {} : {}".format("tbl_truck_loads_df", str(e)))
    raise DataTransformationException(TAG_T,"ReadException","Failed to select the column from {}".format("tbl_truck_loads_df"))
...
def mog_transform_tbl_truck_dumps(base_input_path, site_executor, input_config):
  logger.info(TAG_T,"Performaing Transformation for Trucks Dumps")
  ...
  try:
    ...
    logger.error(TAG_T,"ReadException","Failed to read the data from path {}: {}".format(STG_MOG_EQUIPEMENT, str(e)))
    raise DataTransformationException(TAG_T,"ReadException","Failed to read the data from table {}".format(STG_MOG_EQUIPEMENT))
  try:
    ...
    logger.error(TAG_T,"ReadException","Failed to read the data from path {}: {}".format(shift_dumps_path, str(e)))
    raise DataTransformationException(TAG_T,"ReadException","Failed to read the data from path {}".format(shift_dumps_path))
  ...
  try:
    ...
    logger.error(TAG_LBT,"ReadException","Failed to read the data from path {}: {}".format(enum_path, str(e)))
    raise DataTransformationException(TAG_LBT,"ReadException","Failed to read the data from table {}".format(enum_path))
  ...
  try:
    ...
    logger.error(TAG_T,"ReadException","Failed to read the data from path {}: {}".format(shift_toper_path, str(e)))
    raise DataTransformationException(TAG_T,"ReadException","Failed to read the data from path {}".format(shift_toper_path))
  ...
  try:
    ...
    logger.error(TAG_T,"ReadException","Failed to read the data from path {}: {}".format(shift_locations_path, str(e)))
    raise DataTransformationException(TAG_T,"ReadException","Failed to read the data from path {}".format(shift_locations_path))
  ...
  try:
    ...
    message = "Failed to perform join between the source tables : {}".format(str(e))
    logger.error(TAG_T,"ReadException",message)
    raise DataTransformationException(TAG_T,"ReadException",message)
  ...
  try:
    ...
    try:
      ...
      logger.error(TAG_T,"ReadException","Failed to read the data from path {}: {}".format("tbl_truck_dump_df", str(e)))
      raise DataTransformationException(TAG_T,"ReadException","Failed to read the data from path {}".format("tbl_truck_loads_df"))
      
  except Exception as e:
    message = "Failed to perform either column renamad or new column creation : {}".format(str(e))
    logger.error(TAG_T,"RenamedException",message)
    raise DataTransformationException(TAG_T,"RenamedException",message)
...
# DBTITLE 1,Enum
def mog_transform_tbl_enum(base_input_path, site_executor, input_config):
  ...
  try:
    ...
    logger.error(TAG_T,"ReadException","Failed to read the data from path {}: {}".format(enum_path, str(e)))
    raise DataTransformationException(TAG_T,"ReadException","Failed to read the data from table {}".format(enum_path))
...
def mog_transform_tbl_shift_info(base_input_path, site_executor, input_config):
  logger.info(TAG_T,"Performaing Transformation for shiftinfo")
  ...
  try:
    ...
    logger.error(TAG_T,"ReadException","Failed to read the data from path {}: {}".format(shift_info_path, str(e)))
    raise DataTransformationException(TAG_T,"ReadException","Failed to read the data from table {}".format(shift_info_path))
...
# DBTITLE 1,Person
def mog_transform_tbl_person(base_input_path, site_executor, input_config):
  logger.info(TAG_T,"Performaing Transformation for person")
  ...
  try:
    ...
    logger.error(TAG_T,"ReadException","Failed to read the data from path {}: {}".format(person_path, str(e)))
    raise DataTransformationException(TAG_T,"ReadException","Failed to read the data from table {}".format(person_path))
...
# DBTITLE 1,Enum CREW
def mog_transform_tbl_enum_crew(base_input_path, site_executor, input_config):
  logger.info(TAG_T,"Performaing Transformation for enum crew")
  ...
  try:
    ...
    logger.error(TAG_T,"ReadException","Failed to read the data from path {}: {}".format(enum_crew_path, str(e)))
    raise DataTransformationException(TAG_T,"ReadException","Failed to read the data from table {}".format(enum_crew_path))
    
  return tbl_enum_crew_df.distinct()

# COMMAND ----------

class MogalakwenaTransformationsFms:
  def execute(self, data_dict, site_executor, input_config):
    logger.info(TAG_T,"Excuting for site {}".format(input_config.site))
    error_count = 0
    
    try:
      base_input_path = site_executor.get_adls2_path(CURATED, input_config)
      logger.info(TAG_CTS,"Base_input_path : "+base_input_path)
    ...
    try:
      ...
      tbl_Equipment_df = mog_transform_tbl_Equipment(base_input_path, site_executor,input_config)
      data_dict[STG_MOG_EQUIPEMENT] = tbl_Equipment_df
    except DataTransformationException as e:
      logger.error(TAG_T,"TransformationException","Failed to transform the data for table: {}".format(STG_MOG_EQUIPEMENT))
      error_count += 1
      
    try:
      data_dict[STG_MOG_EQUIPEMENT_STATUS] = None
      tbl_Equipment_Status_df = mog_transform_tbl_equipment_status(base_input_path, site_executor, input_config)
      data_dict[STG_MOG_EQUIPEMENT_STATUS] = tbl_Equipment_Status_df
    except DataTransformationException as e:
      logger.error(TAG_T,"TransformationException","Failed to transform the data for \
      table: {}".format(STG_MOG_EQUIPEMENT_STATUS))
      error_count += 1
      
    try:
      data_dict[STG_MOG_DELAY_REASON] = None
      tbl_Delay_Reasons_df = mog_transform_tbl_delay_reasons(base_input_path, site_executor, input_config)
      data_dict[STG_MOG_DELAY_REASON] = tbl_Delay_Reasons_df
    except DataTransformationException as e:
      logger.error(TAG_T,"TransformationException","Failed to transform the data for table: {}".format(STG_MOG_DELAY_REASON))
      error_count += 1
      
    try:
      data_dict[STG_MOG_SHOVEL_BUCKETS] = None
      tbl_Shovel_Buckets_df = mog_transform_tbl_shovel_buckets(base_input_path, site_executor, input_config)
      data_dict[STG_MOG_SHOVEL_BUCKETS] = tbl_Shovel_Buckets_df
    except DataTransformationException as e:
      logger.error(TAG_T,"TransformationException","Failed to transform the data for table: {}".format(STG_MOG_SHOVEL_BUCKETS))
      error_count += 1
      
    try:
      data_dict[STG_MOG_MATERIAL] = None
      tbl_Material_df = mog_transform_tbl_material(base_input_path, site_executor, input_config)
      data_dict[STG_MOG_MATERIAL] = tbl_Material_df
    except DataTransformationException as e:
      logger.error(TAG_T,"TransformationException","Failed to transform the data for table: {}".format(STG_MOG_MATERIAL))
      error_count += 1
      
    try:
      data_dict[STG_MOG_TRUCK_LOADS] = None
      tbl_Truck_Loads_df = mog_transform_tbl_truck_loads(base_input_path, site_executor, input_config)
      data_dict[STG_MOG_TRUCK_LOADS] = tbl_Truck_Loads_df      
    except DataTransformationException as e:
      logger.error(TAG_T,"TransformationException","Failed to transform the data for table: {}".format(STG_MOG_TRUCK_LOADS) + "\n" + e.message)
      error_count += 1
      
    try:
      data_dict[STG_MOG_TRUCK_DUMPS] = None
      tbl_Truck_Dumps_df = mog_transform_tbl_truck_dumps(base_input_path, site_executor, input_config)
      data_dict[STG_MOG_TRUCK_DUMPS] = tbl_Truck_Dumps_df      
    except DataTransformationException as e:
      logger.error(TAG_T,"TransformationException","Failed to transform the data for table: {}".format(STG_MOG_TRUCK_DUMPS) + "\n" + e.message)
      error_count += 1
      
    try:
      data_dict[STG_MOG_ENUM] = None
      tbl_Enum_df = mog_transform_tbl_enum(base_input_path, site_executor, input_config)
      data_dict[STG_MOG_ENUM] = tbl_Enum_df      
    except DataTransformationException as e:
      logger.error(TAG_T,"TransformationException","Failed to transform the data for table: {}".format(STG_MOG_ENUM) + "\n" + e.message)
      error_count += 1
      
    try:
      data_dict[STG_MOG_SHIFT_INFO] = None
      tbl_shift_info_df = mog_transform_tbl_shift_info(base_input_path, site_executor, input_config)
      data_dict[STG_MOG_SHIFT_INFO] = tbl_shift_info_df      
    except DataTransformationException as e:
      logger.error(TAG_T,"TransformationException","Failed to transform the data for table: {}".format(STG_MOG_SHIFT_INFO) + "\n" + e.message)
      error_count += 1
      
    try:
      data_dict[STG_MOG_PERSON] = None
      tbl_person_df = mog_transform_tbl_person(base_input_path, site_executor, input_config)
      data_dict[STG_MOG_PERSON] = tbl_person_df      
    except DataTransformationException as e:
      logger.error(TAG_T,"TransformationException","Failed to transform the data for table: {}".format(STG_MOG_PERSON) + "\n" + e.message)
      error_count += 1
      
    try:
      data_dict[STG_MOG_ENUM_CREW] = None
      tbl_enum_crew_df = mog_transform_tbl_enum_crew(base_input_path, site_executor, input_config)
      data_dict[STG_MOG_ENUM_CREW] = tbl_enum_crew_df      
    except DataTransformationException as e:
      logger.error(TAG_T,"TransformationException","Failed to transform the data for table: {}".format(STG_MOG_ENUM_CREW) + "\n" + e.message)
      error_count += 1
